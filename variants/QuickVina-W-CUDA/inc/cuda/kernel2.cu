	...
	int* count_id)
{
	...
	// quickvina-W: need (center_x, center_y, center_z, size_x, size_y, size_z)
...
void kernel_monte(
	...
	int* count_id)
{
	dim3 grid_size(128, 52, 1); // thread = 6656
	...
	kernel2_update<<<grid_size, block_size>>>(ric, mg, pre, grids, random_maps, coords, results, mis, torsion_size,
											  ...
											  //quickvina-W
											  center_x, center_y, center_z, size_x, size_y, size_z, global_ptr, count_id);
