...
#ifdef LARGE_BOX
    // Removed -Werror for newer GPU drivers (RTX 5090)
    std::string option = " -cl-single-precision-constant -cl-unsafe-math-optimizations -DLARGE_BOX -cl-mad-enable -cl-std=";
#endif
#ifdef SMALL_BOX
    // Removed -Werror for newer GPU drivers (RTX 5090)
    std::string option = " -cl-single-precision-constant -cl-unsafe-math-optimizations -DSMALL_BOX -cl-mad-enable -cl-std=";
#endif
#ifdef OPENCL_1_2
